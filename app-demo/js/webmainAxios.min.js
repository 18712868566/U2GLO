...
var Projet_Global_Parameter = {
    ...
    fbShare: function (id = '') {
        try {
            FB.ui({
                method: "share",
                href: "http://ee-hero.com/pre/index.html"
            },
                function (response) {
                    if (response) {
                        // 分享成功
...
$(function () {
    ...
    Projet_Global_Parameter.createPersonNum('00986758');
