...
!function(s) {
    ...
    return g.fn.tilt = function(i) {
        function s(t) {
            ...
            }), r.call(this), g(this).trigger("tilt.mouseEnter");
        }
        function e(t) {
            this.mousePositions = l(t), o.call(this);
        }
        function n() {
            r.call(this), this.reset = !0, o.call(this), g(this).trigger("tilt.mouseLeave");
        }
        function a() {
        ...
        var o = function() {
            ...
            var t = g(this).outerWidth(), i = g(this).outerHeight(), s = g(this).offset().left, e = g(this).offset().top, n = (this.mousePositions.x - s) / t, a = (this.mousePositions.y - e) / i;
            return {
            ...
            return this.transforms = h.call(this), this.reset ? (this.reset = !1, 
            ...
            g(this).trigger("change", [ this.transforms ]), void (this.ticking = !1));
        };
        return g.fn.tilt.destroy = function() {
            ...
            return g(this).each(function() {
                this.mousePositions = l.call(this), t.push(h.call(this));
            }), t;
        }, g.fn.tilt.reset = function() {
            g(this).each(function() {
                var t = this;
                this.mousePositions = l.call(this), this.settings = g(this).data("settings"), 
            ...
            }, i), null !== this.settings.axis && (this.settings.disableAxis = this.settings.axis), 
            this.init = function() {
                g(t).data("settings", t.settings), t.settings.glare && function() {
                    ...
                    this.glareElementWrapper = g(this).find(".js-tilt-glare"), this.glareElement = g(this).find(".js-tilt-glare-inner"), 
                    ...
                    g(this).on("mousemove", e), g(this).on("mouseenter", s), this.settings.reset && g(this).on("mouseleave", n), 
                    this.settings.glare && g(window).on("resize", a.bind(this));
                }.call(t);
            }, this.init();
        });
    }, g("[data-tilt]").tilt(), !0;
